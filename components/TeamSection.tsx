    ...
    <section id="sobre" className="py-24 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-sm font-black uppercase tracking-[0.4em] text-orange-500 mb-4">Quem somos</h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4">
               <div className="aspect-square bg-zinc-900 rounded-2xl overflow-hidden grayscale">
                 <img src="https://picsum.photos/seed/team1/400/400" alt="Team member context" className="w-full h-full object-cover opacity-40" />
               </div>
               <div className="aspect-[3/4] bg-zinc-900 rounded-2xl overflow-hidden grayscale translate-x-4">
                 <img src="https://picsum.photos/seed/team2/400/533" alt="Team member context" className="w-full h-full object-cover opacity-40" />
               </div>
            </div>
            <div className="space-y-4 pt-8">
               <div className="aspect-[3/4] bg-zinc-900 rounded-2xl overflow-hidden grayscale">
                 <img src="https://picsum.photos/seed/team3/400/533" alt="Team member context" className="w-full h-full object-cover opacity-40" />
               </div>
               <div className="aspect-square bg-zinc-900 rounded-2xl overflow-hidden grayscale -translate-x-4">
                 <img src="https://picsum.photos/seed/team4/400/400" alt="Team member context" className="w-full h-full object-cover opacity-40" />
               </div>
            </div>
          </div>
        </div>
